...
public interface StudentCustomRepository {
    ...
    Page<Student> getStudentsByUserIdAndGroupIdOrStudentNameOrPhoneNumWithPaging(String currentUserId, Pageable pageable, List<Long> groupIds, String studentNameORPhoneNum);
    Page<Student> getUnpaidStudentsByUserIdAndGroupIdOrStudentNameOrPhoneNumWithPaging(String currentUserId, Pageable pageable, List<Long> groupId, String studentNameORPhoneNum);
